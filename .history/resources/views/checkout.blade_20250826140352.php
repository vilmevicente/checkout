    ...
    <style>
        ...
        * {
        ...
        .benefit-card:hover {
            ...
            box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10极速赛车开奖直播px -5px rgba(0, 0, 0, 0.04);
        }
        ...
        .benefit-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #4f46e5, #8b极速赛车开奖直播5cf6);
        }
        ...
        .top-banner {
            background: linear-gradient(90deg, #4f46e5 极速赛车开奖直播0%, #6366f1 100%);
            color: white;
            text-align: center;
            padding: 14px;
            font-weight: 600;
        ...
        input:focus, select:focus {
            border-color: #4极速赛车开奖直播f46e5;
            box-shadow: 极速赛车开奖直播0 0 0 3px rgba(79, 70, 229, 0.2);
        }
...
<body>
    ...
    <!-- Header Banner -->
    <div class="countdown text-white text-center py-3 px极速赛车开奖直播-4 font-bold">
        ...
        <div class="container px-4 py-6">
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex items-center gap-4 text-sm text-gray-600 mt-4 md:mt-0">
                    ...
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15极速赛车开奖直播v2m-6 4h12a2 2 0 01-2-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                        </svg>
    ...
    <div class="container px-4 py-8 flex-1">
        <!-- Banner principal -->
        <img src="https://aws-assets.kiwify.com.br/cdn-cgi/image/fit=scale-down,width=1000/aIr8nqdeg极速赛车开奖直播Lp8KtQ/img_builder_83极速赛车开奖直播d39bc7-7006-45eb-8c04-5c81f83424cb_73b70945391b48cc8af190b4934096fd.png" alt="Banner Principal" class="w-full mb-8 rounded-lg shadow-card">
        
        <!-- Benefits Banner -->
        <div class="benefits-banner">
            <i class="fas fa-gift mr极速赛车开奖直播-2"></i> SEUS BENEFÍCIOS EXCLUSIVOS
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            @foreach($mainProduct['features'] as $feature)
                <div class="benefit-card shadow-card text-center p-6 rounded-xl bg-white">
                    <div class="icon-container text-indigo-600 text-3极速赛车开奖直播xl mb-3">
        ...
        <form id="checkout-form" method="POST" action="{{ route('checkout.process') }}">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:极速赛车开奖直播outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                            ...
                            <div class="space-y-2">
                                ...
                                @error('email_confirmation')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></极速赛车开奖直播i>
                                        <span>{{ $message }}</span>
                                    </div>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                @error('phone')
                                    <div class="error极速赛车开奖直播-message">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <span>{{ $message }}</span>
                                    </div>
                                @enderror
                                ...
                                <div class="flex-1">
                                    <label for="upsell-{{ $index }}" class="font-medium text-sm cursor-pointer block">
                                        <input type="checkbox" 
                                               ...
                                               name="upsells[]"
                                               value="{{ $upsell['id'] }}"
                                               class="mr-2 h-5 w极速赛车开奖直播-5 text-indigo-600 border-gray-300 rounded upsell-checkbox"
                    ...
                    <!-- Order Summary -->
                    <div class="bg-white rounded-xl shadow-card p-6">
                        <h2 class="text-lg font-semib极速赛车开奖直播old mb-4">Resumo do Pedido</h2>
                        
                        <!-- Main Product -->
                        <div class="flex gap-3极速赛车开奖直播 mb-4">
                            <div class="w-16 h-16 rounded-md bg-indigo-100 flex items-center justify-center">
                                <i class="fas fa-graduation-cap text-indigo-600 text-xl"></i>
                            </div>
                            <div class="flex-1">
                                <极速赛车开奖直播h3 class="font-medium text-sm">{{ $mainProduct['name'] }}</h3>
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="font-bold text-indigo-600">R$ {{ number_format($mainProduct['price'], 2, ',', '.') }}</span>
                                    <span class="text-sm text-gray-500 line-through">
                                        R$ {{ number_format($mainProduct['originalPrice'], 2, ',', '.') }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div x-show="selectedUpsells.length > 0" class="mb-4">
                            ...
                            <div id="upsells-list">
                                <template x-for="upsell in selectedUpsells" :key="upsell.id">
                                    <极速赛车开奖直播div class="flex justify-between text-sm mb-1">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Security Badges -->
                    <div class="bg-white rounded-xl shadow-card p-6">
                        <h2 class="text-lg font-semibold mb-4">Segurança</极速赛车开奖直播h2>
    ...
    <div id="pix-modal" class="pix-modal" x-show="showPixModal" style="display: none;">
        <div class="pix-content">
            ...
            <div class="mb-4">
                <p class="text-sm text-gray-600 mb-2">Ou copie o código PIX:</极速赛车开奖直播p>
                <div class="flex items-center">
                    ...
                    <button id="copy-p极速赛车开奖直播ix" class="copy-btn rounded-l-none" @click="copyPixCode">Copiar</button>
                </极速赛车开奖直播div>
            </div>
    ...
    <script>
        ...
        function checkout() {
            return {
                ...
                totalSavings: {{ $mainProduct['originalPrice'] - $mainProduct['price'] }},
                isProcessing: false,
                showPixModal: false,
                pixCode: '',
                ...
                validateForm() {
                    ...
                    this.validate极速赛车开奖直播Field('email_confirmation');
                ...
                async processPayment() {
                    ...
                    try {
                        ...
                        // Adicionar reCAPTCHA - CORREÇÃO DO PROBLEMA
                        @if(App\Helpers\ConfigHelper::isRecaptchaEnabled())
                            if (typeof grecaptcha !== 'undefined') {
                                const recaptchaResponse = grecaptcha.getResponse();
                                if (recaptchaResponse) {
                        ...
                        // Enviar via AJAX
                        const response = await fetch('{{ route("checkout.generate-pix") }}', {
                            method: 'POST',
                            body: formData
                        });
