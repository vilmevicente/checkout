            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-elevated p-6 mb-8">
                    ...
                    <div class="flex items-start gap-4 border rounded-xl p-4 mb-6 upsell-item">
                        <img src="https://assets.kiwify.com.br/cdn-cgi/image/fit=scale-down,width=64/aIr8nqdegLp8KtQ/NOVO_ZAP_02_bcbd62709f224ab6b0cbc64de782d6dd.png" alt="Instagram Ads Avançado" class="w-16 h-16 rounded-lg object-cover">
                        <div class="flex-1">
                            <label for="upsell-up1" class="font-medium text-sm cursor-pointer block">
                                <input type="checkbox" 
                                       id="upsell-up1" 
                                       class="mr-2 h-5 w-5 text-indigo-600 border-gray-300 rounded upsell-checkbox"
                                       data-price="97"
                                       data-name="Instagram Ads Avançado">
                                Instagram Ads Avançado - <span class="font-semibold">R$ 97,00</span>
                            </label>
                            <p class="text-xs text-gray-500 mt-1">De <span class="line-through">R$ 197,00</span> por apenas 50% OFF</p>
                        </div>
                    </div>

                    <div class="flex items-start gap-4 border rounded-xl p-4 mb-6 upsell-item">
                        <img src="https://assets.kiwify.com.br/cdn-cgi/image/fit=scale-down,width=64/aIr8nqdegLp8KtQ/NOVO_ZAP_02_bcbd62709f224ab6b0cbc64de782d6dd.png" alt="Templates Premium" class="w-16 h-16 rounded-lg object-cover">
                        <div class="flex-1">
                            <label for="upsell-up2" class="font-medium text-sm cursor-pointer block">
                                <input type="checkbox" 
                                       id="upsell-up2" 
                                       class="mr-2 h-5 w-5 text-indigo-600 border-gray-300 rounded upsell-checkbox"
                                       data-price="47"
                                       data-name="Templates Premium">
                                Templates Premium - <span class="font-semibold">R$ 47,00</span>
                            </label>
                            <p class="text-xs text-gray-500 mt-1">De <span class="line-through">R$ 97,00</span> por apenas 52% OFF</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-indigo-50 rounded-xl shadow-inner p-6 mb-8">
                    ...
                    <div class="flex items-start mb-6">
                        <img src="https://i.pravatar.cc/60?img=12" alt="@joaosilva" class="w-12 h-12 rounded-full shadow-md mr-4">
                        <div>
                            ...
                            <span class="text-xs text-indigo-600 mt-2 block">
                                <i class="fas fa-user-circle mr-1"></i>@joaosilva
                            </span>
                        </div>
                    </div>

                    <div class="flex items-start mb-6">
                        <img src="https://i.pravatar.cc/60?img=32" alt="@mariaoliveira" class="w-12 h-12 rounded-full shadow-md mr-4">
                        <div>
                            <p class="text-sm font-medium">
                                <i class="fas fa-quote-left text-indigo-500 mr-2"></i>
                            ...
                            <span class="text-xs text-indigo-600 mt-2 block">
                                <i class="fas fa-user-circle mr-1"></i>@mariaoliveira
                            </span>
                        </div>
                    </div>
                </div>
