...
@section('title', 'Criar Upsell')

@section('content')
<div class="bg-white shadow rounded-lg max-w-2xl mx-auto">
    <div class="px-4 py-5 sm:p-6">
        <h3 class="text-lg font-medium text-gray-900 mb-6">Criar Novo Upsell</h3>

        <form action="{{ route('admin.upsells.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Se preenchido, será mostrado como preço riscado.</p>
                </div>
