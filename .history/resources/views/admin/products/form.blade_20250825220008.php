...
<div x-data="productForm()">
    ...
    <form method="POST" 
        ...
        <div class="mb-8">
            <h2 class="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">
                <span class="paper-plane-icon">📨</span> Método de Entrega *
            </h2>
            ...
            <div class="relative">
                <select 
                    ...
                    class="custom-select w-full px-4 py-3 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white text-gray-700 cursor-pointer"
                    required>
                    <option value="">Selecione como o produto será entregue</option>
