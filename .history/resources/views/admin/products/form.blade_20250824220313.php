...
<div x-data="productForm()">
    ...
    <form 
     method="POST" 
        action="{{ isset($product) ? route('products.update', $product) : route('admin.products.store') }}" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="file" name="main_banner" accept="image/*"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    @if(isset($product) && $product->main_banner_url)
                    <div class="mt-2">
                        <img src="{{ $product->main_banner_url }}" alt="Banner principal" class="h-20 object-cover rounded">
                ...
                <div>
                    ...
                    <input type="file" name="secondary_banner" accept="image/*"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    @if(isset($product) && $product->secondary_banner_url)
                    <div class="mt-2">
                        <img src="{{ $product->secondary_banner_url }}" alt="Banner secundário" class="h-20 object-cover rounded">
                        <p class="text-xs text-gray-500 mt-1">Banner atual</p>
                    </div>
                    @endif
                </div>
