...
<div x-data="{
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
            ...
            <img src="/storage/ $product->main_banner_url }}" alt="{{ $product->name }}" class="w-full h-48 object-cover">
            @else
            ...
            <div class="p-6">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('admin.products.edit', $product) }}" class="text-blue-500 hover:text-blue-700 transition" title="Editar">
                        ...
                        <button @click="deleteProduct({{ $product->id }}, '{{ addslashes($product->name) }}')" class="text-red-500 hover:text-red-700 transition" title="Excluir">
