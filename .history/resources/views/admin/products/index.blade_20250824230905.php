            ...
            <div class="p-6">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('admin.products.edit', $product) }}" class="text-blue-500 hover:text-blue-700 transition" title="Editar" style="display: block !important;">
                        ...
                        <button @click="deleteProduct({{ $product->id }}, '{{ addslashes($product->name) }}')" class="text-red-500 hover:text-red-700 transition" style="display:block !important;"title="Excluir">
