...
<div x-data="{
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admproducts.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition">
    ...
    <div class="bg-white rounded-lg shadow p-6 text-center">
        ...
        <a href="{{ route('products.create') }}" class="inline-block mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
            ...
            <img src="{{ $product->main_banner }}" alt="{{ $product->name }}" class="w-full h-48 object-cover">
            @else
            ...
            <div class="p-6">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('products.edit', $product) }}" class="text-blue-500 hover:text-blue-700 transition">
