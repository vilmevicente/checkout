...
<head>
    ...
    <title>Configurações do Checkout</title>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="text" name="company_name" id="company_name"
                                   class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500"
                                   value="{{ old('company_name', $configs['company_name']->value ?? '') }}"
                                   placeholder="Ex: PUBLIC DIGITAL - AGENCIA DE MARKETING DIGITAL LTDA">
                        </div>

                        <div class="mt-4">
                            <label for="retailer_name" class="block text-sm font-medium text-gray-700">
                                Nome do Revendedor
                            </label>
                            <input type="text" name="retailer_name" id="retailer_name"
                                   class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500"
                                   value="{{ old('retailer_name', $configs['retailer_name']->value ?? '') }}"
                                   placeholder="Ex: Kuwiy">
                        </div>
                    </div>
