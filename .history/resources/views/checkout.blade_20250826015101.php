...
<body>
                    ...
                    <div class="bg-white rounded-xl shadow-elevated p-6 mb-8">
                        ...
                        @foreach($upsells as $index => $upsell)
                            <div class="flex items-start gap-4 border rounded-xl p-4 mb-6 upsell-item"> 
                                <img src="/storage/{{ $upsell['secondarybanner'] }}" 
                                     alt="{{ $upsell['name'] }}" 
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6">
                        ...
                        <div class="flex justify-between items-center text-sm mb-4">
                            ...
                            <span id="savings-amount" class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded">
                               <span id="savings-amount" class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded">
    R$ {{ number_format(floatval($mainProduct['originalPrice']) - floatval($mainProduct['price']), 2, ',', '.') }}
                            </span>
                        </div>
                        ...
                        <!-- Pay Button -->
                        <button type="button" id="pay-button" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-4 rounded-lg transition duration-200 mt-4 btn-primary">
    ...
    <div id="pix-modal" class="pix-modal">
        <div class="pix-content">
            ...
            <button id="confirm-payment" class="w-full bg-indigo-600 text-white py-2 px-4 rounded-lg">Confirmar Pagamento</button>
            <button id="close-pix" class="w-full mt-2 bg-gray-300 text-gray-700 py-2 px-4 rounded-lg">Fechar</button>
        </div>
    </div>
    ...
    <script>
        ...
        function updateTotal() {
            ...
            let savings = parseFloat(mainProduct.originalPrice) - parseFloat(mainProduct.price);
