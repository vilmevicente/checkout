...
<div class="bg-white rounded-xl shadow-elevated p-6 mb-8">
  ...
  <div class="flex items-start gap-4 border rounded-xl p-4 mb-6">
    <img src="https://assets.kiwify.com.br/cdn-cgi/image/fit=scale-down,width=64/aIr8nqdegLp8KtQ/NOVO_ZAP_02_bcbd62709f224ab6b0cbc64de782d6dd.png" alt="ZAPTurboMAX" class="w-16 h-16 rounded-lg object-cover">
    <div>
      <label for="zap-turbo" class="font-medium text-sm cursor-pointer block">
        <input type="checkbox" id="zap-turbo" class="mr-2 h-5 w-5 text-indigo-600 border-gray-300 rounded">
        <i class="fab fa-whatsapp text-green-500 mr-1"></i>
        ZAPTurboMAX: Melhor software de envio em massa - <span class="font-semibold">$18.00</span>
      </label>
      <p class="text-xs text-gray-500 mt-1">Marque para adicionar ao pedido.</p>
    </div>
  </div>

  <!-- Item 2 -->
  <div class="flex items-start gap-4 border rounded-xl p-4 bg-amber-50 border-amber-200 mb-6">
    <img src="https://assets.kiwify.com.br/cdn-cgi/image/fit=scale-down,width=64/aIr8nqdegLp8KtQ/NOVO_ZAP_02_bcbd62709f224ab6b0cbc64de782d6dd.png" alt="InstaContas" class="w-16 h-16 rounded-lg object-cover">
    <div>
      <h3 class="font-bold text-sm mb-1">InstaContas: Curso Completo</h3>
      <p class="text-xs text-gray-600 mb-2">Aprenda a comprar contas para extração por menos de R$0,50.</p>
      <label for="insta-contas" class="font-medium text-sm cursor-pointer block">
        <input type="checkbox" id="insta-contas" class="mr-2 h-5 w-5 text-indigo-600 border-gray-300 rounded">
        Adicionar ao pedido - <span class="font-semibold">$1.90</span>
      </label>
    </div>
  </div>
</div>
...
<div class="bg-white rounded-xl shadow-card p-6">
            ...
            <img src="https://assets.kiwify.com.br/cdn-cgi/image/fit=scale-down,width=300/aIr8nqdegLp8KtQ/img_builder_da7b3666-3843-43c0-b82d-654cad7a67b2_d7caa1c6d0824964a63e4fa4c5ec5373.png" alt="Banner Principal" class="w-full mb-4 rounded-lg shadow-card">
...
<div class="bg-indigo-50 rounded-xl shadow-inner p-6 mb-8">
  ...
  <div class="flex items-start mb-6">
    <!-- Imagem do usuário -->
    <img src="https://i.pravatar.cc/60?img=12" alt="@pizarri888ss" 
    ...
    <div>
      ...
      <a href="https://www.pizarri888ss.com" 
         class="text-xs text-indigo-600 mt-2 block">
  ...
  <div class="flex items-start">
    <!-- Imagem do usuário -->
    <img src="https://i.pravatar.cc/60?img=32" alt="@letica_souza" 
         class="w-12 h-12 rounded-full shadow-md mr-4">
    <div>
      <p class="text-sm font-medium">
        <i class="fas fa-quote-left text-indigo-500 mr-2"></i>
        "As aulas ao vivo e a ferramenta são excelentes! Parabéns à equipe."
      </p>
      <a href="https://www.letica_souza.com" 
         class="text-xs text-indigo-600 mt-2 block">
