...
class CheckoutController extends Controller
{
    ...
    public function index()
    {
        ...
        'features' => [
            '0' => ['name' => 'Acesso Imediato!', 'description' => 'Utilize já após a compra', 'icon' => 'fas fa-check-circle'],
            '1' => ['name' => 'Suporte Exclusivo!', 'description' => 'Através do WhatsApp', 'icon' => 'fas fa-comments'],
            '2' => ['name' => 'Treinamento VIP!', 'description' => 'Todas as funcionalidades', 'icon' => 'fas fa-star'],
        ],
    ...
    $depoimentos = [
        ...
        ['name' => 'Maria Oliveira', 'text' => 'As aulas ao vivo e a ferramenta são excelentes! Parabéns à equipe.', 'image' => '/placeholder.svg', 'username' => '@mariaoliveira'],
