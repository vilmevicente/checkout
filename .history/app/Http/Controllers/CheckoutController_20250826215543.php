      ...
      public function process(Request $request)
{
    ...
    try {
        return DB::transaction(function () use ($request) {
            ...
            $order->update([
                'pix_code' => $pixCode,
                'pix_response' => json_encode($response), // Salvar resposta completa para debug
            ...
            return response()->json([
                ...
                'order' => [
                    ...
                    'total' => $order->total,
                    'pix_code' => $pixCode,
                    'pix_expires_at' => $order->pix_expires_at->format('d/m/Y H:i:s')
                ],
                'redirect_url' => route('order.show', $order->reference)
            ]);
