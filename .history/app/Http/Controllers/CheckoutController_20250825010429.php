    ...
    public function index()
{
    ...
    $upsells = $mainProduct->upsells->map(function($upsell) {
        return [
            ...
            'image' => $upsell->main_banner_url // ou secondary_banner_url, dependendo da sua necessidade
        ];
    })->toArray();
    ...
    $depoimentos = $mainProduct->testimonials->map(function($testimonial) {
        return [
            ...
            'text' => $testimonial->content, // assumindo que há um campo 'content'
            'image' => $testimonial->image_url, // assumindo que há um accessor para image_url
