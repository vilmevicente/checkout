...
class ProductController extends Controller
{
  ...
  public function index()
    ...
    public function create()
    {
        ...
        return view('products.form', compact('products', 'deliveryMethods', 'upsellsData', 'attachmentsData', 'deliveryMethodsData', 'filesMethodId'));
    }
    ...
    public function edit(Product $product)
{
    ...
    return view('admin.products.form', compact('product', 'products', 'deliveryMethods', 'upsellsData', 'attachmentsData', 'deliveryMethodsData', 'filesMethodId'));
}
