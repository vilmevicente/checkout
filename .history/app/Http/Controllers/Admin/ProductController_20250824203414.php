...
public function create()
{
    ...
    return view('products.form', compact('products', 'deliveryMethods'));
}
...
public function edit(Product $product)
{
    ...
    return view('products.form', compact('product', 'products', 'deliveryMethods', 'currentUpsells'));
}
    ...
    public function edit(Product $product)
    {
        ...
        return view('products.edit', compact('product', 'products', 'deliveryMethods', 'currentUpsells'));
    }
