...
class CheckoutController extends Controller
{
    ...
    public function index()
    {
        ...
        'features' => [
            ...
            'Aulas práticas com estudos de caso reais',
            'Suporte direto com os instrutores via fórum exclusivo',
            'Atualizações constantes com as últimas tendências do mercado',
        ], 
        'guarantee' => 'Garantia de 30 dias: Se você não estiver satisfeito com o curso, devolvemos seu dinheiro sem complicações.',
        'bonuses' => [
            '0' => ['name' => 'E-book de Estratégias Avançadas', 'description' => 'Um guia completo com táticas avançadas de marketing digital para levar seu conhecimento ao próximo nível.'],
            '1' => ['name' => 'Webinar Exclusivo Mensal', 'description' => 'Acesso a webinars mensais com especialistas do setor para discutir as últimas tendências e responder suas perguntas.'],
            '2' => ['name' => 'Grupo Privado no Facebook', 'description' => 'Participe de uma comunidade exclusiva para networking, troca de ideias e suporte entre alunos e
        ],
        'paymentMethods' => ['Cartão de Crédito', 'Boleto Bancário', 'Pix', 'PayPal'],
