...
class PagFanService
{
    ...
    public function __construct($clientId, $clientSecret, $baseUrl, $postbackUrl)
    {
     ...
     * Gera QRCode PIX
     */
    public function generateQrCode($amount, $externalId, $payer, $payerQuestion)
    {
        try {
            $token = $this->getAccessToken();
