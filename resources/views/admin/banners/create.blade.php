...
<div class="bg-white shadow rounded-lg max-w-2xl mx-auto">
    <div class="px-4 py-5 sm:p-6">
        <h3 class="text-lg font-medium text-gray-900 mb-6">Criar Novo Banner</h3>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <select name="position" id="position" required
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                        <option value="top" {{ old('position') == 'top' ? 'selected' : '' }}>Topo</option>
                        <option value="middle" {{ old('position') == 'middle' ? 'selected' : '' }}>Meio</option>
                        <option value="bottom" {{ old('position') == 'bottom' ? 'selected' : '' }}>Rodapé</option>
                    </select>
                </div>
